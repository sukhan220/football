...
import { SquarePen, Home } from "lucide-react"; // 👈 Home আইকন যুক্ত করা হয়েছে
...
const AppHeader: React.FC = () => {
  ...
  // 📝 চেক করা হচ্ছে ইউজার ক্রিয়েট পেইজে আছে কি না
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        >
          {/* 🛠️ অ্যাকশন বাটন এরিয়া */}
          <div className="flex items-center gap-3.5">
            
            {/* 🏠 হোমপেইজে যাওয়ার জন্য নতুন আইকন বাটন */}
            <Link
              href="/"
              className="flex items-center justify-center w-10 h-10 text-gray-500 rounded-lg border border-gray-200 hover:bg-gray-50 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-800 transition"
              title="Go to Home"
            >
              <Home size={18} />
            </Link>

            {/* ✍️ রাইটিং পেন বাটন (অ্যাক্টিভ কন্ডিশনসহ) */}
            <Link
              href="/admin/create"
              className={`flex items-center justify-center w-10 h-10 rounded-lg border transition ${
                isCreatePage
                  ? "bg-zinc-950 border-zinc-950 text-white dark:bg-white dark:border-white dark:text-zinc-950 shadow-sm" // Active State
                  : "text-gray-500 border-gray-200 hover:bg-gray-50 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-800" // Normal State
              }`}
