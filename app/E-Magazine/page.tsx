...
//     },
//     {
//       title: "OFFSIDE and ONSIDE",
//       slug: "technology",
//       desc: "VAR data, smart chip balls and future tech.",
//       path: "/E-Magazine/offside",
//       color: "from-cyan-500",
...
export default function EMagazineRootPage() {
  ...
  // ⚡ ফুলস্ক্রিন অ্যাক্টিভেট করার ফাংশন
  ...
  const handleCardClick = (e: React.MouseEvent<HTMLDivElement>, path: string) => {
    ...
    // ট্রিক: কার্ডে ক্লিক করার সাথে সাথেই ফুলস্ক্রিন ট্রিগার হবে
    triggerFullscreen();
  ...
  useEffect(() => {
    // ⚡ রিফ্রেশ করার পর ইউজার স্ক্রিনে যেকোনো প্রথম ক্লিক করলেই ফুলস্ক্রিন হয়ে যাবে
    const handleFirstClick = () => {
      triggerFullscreen();
      // একবার ফুলস্ক্রিন হয়ে গেলে ইভেন্ট রিমুভ করে দেব
