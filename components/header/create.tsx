...
// //   // ল্যাঙ্গুয়েজ সুইচ করলে ক্যাটাগরি সিলেকশন রিসেট হবে এবং স্লাগ রি-জেনারেট হবে
// //   useEffect(() => {
// //     setCategoryId("");
// //     if (title) {
...
// //       holder: "editorjs",
// //       placeholder: "মিডিয়ামের মতো খবরের বডি লিখুন এবং ইমেজ পেস্ট করুন...",
// //       tools: {
...
// //   // টাইটেল ও ল্যাঙ্গুয়েজ এর উপর বেস করে স্লাগ হ্যান্ডলিং
...
// //       strict: false, 
// //       trim: true,
// //       locale: currentLang === "BN" ? "bg" : "en" // বাংলা ক্যারেক্টার সাপোর্ট সেফ রাখার জন্য
// //     });
...
// //             {/* 🖼️ ১. স্লিম কভার ব্যান্তর (Aspect Ratio 32:9 - image_36d407.png এর মতো নিখুঁত সাইজ) */}
...
// //                   {/* 📝 ব্যানার ক্যাপশন ও ক্রেডিট ইনপুট */}
...
// //               {/* 🛠️ ২. কন্ট্রোল বার (ল্যাঙ্গুয়েজ সুইচ, ক্যাটাগরি ড্রপডাউন এবং অ্যাকশন বাটনসমূহ) */}
// //               <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 pb-4">
                
// //                 <div className="flex flex-wrap items-center gap-3 text-sm">
                  
// //                   {/* 🌐 নতুন EN/BN ল্যাঙ্গুয়েজ সুইচার (টপ ন্যাভবারের স্টাইলে ক্যানভাসে যুক্ত করা হয়েছে) */}
...
// //                   {/* ক্যাটাগরি সিলেক্টর (ল্যাঙ্গুয়েজ অনুযায়ী ফিল্টারড) */}
...
//     const Paragraph = (await import("@editorjs/paragraph")).default;
//     const ImageTool = (await import("@editorjs/image")).default;
//     const Embed = (await import("@editorjs/embed")).default; // 👈 Embed প্লাগইন ইমপোর্ট করা হয়েছে

//     const editor = new EditorJS({
//       holder: "editorjs",
//       placeholder: "মিডিয়ামের মতো খবরের বডি লিখুন, ইমেজ পেস্ট করুন কিংবা ভিডিও লিংক শেয়ার করুন...",
//       tools: {
//         paragraph: { class: Paragraph, inlineToolbar: true },
//         header: { class: Header, inlineToolbar: true },
//         image: {
...
//           },
//         },
//         // 🎥 ভিডিও লিংক রেন্ডার করার কনফিগারেশন
//         embed: {
//           class: Embed,
//           config: {
//             services: {
...
//               {/* ৬. Editor.js কন্টেইনার (এখানে এখন ভিডিও লিংক অটো-রেন্ডার হবে) */}
//               <div 
//                 id="editorjs" 
//                 className="prose prose-zinc sm:prose-lg max-w-none min-h-[500px] outline-none font-serif text-gray-800 leading-relaxed" 
//               />
